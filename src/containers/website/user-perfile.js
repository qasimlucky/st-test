...
function UserPerfile() {
        ...
        <div class = "user-perfile">    
            ...
            <div style={{display:"flex", width :"67%",  margin :"auto",   position: "relative"}}>
                <div class="stv-profile-p1" style={{height:"275px",width: "31%",padding:"1%",  position: "relative" , float : "left",marginTop:"0 !important", margin:"auto", backgroundColor: "#1d1d41"}}>
                ...
                <div style={{height:"615px", width: "65%", margintop:"0",float : "left",position: "relative", margin:"auto" ,padding : "10px" , backgroundColor: "#1d1d41"}}>
                ...
                <div class="form-group col-6" style={{color:"white"}}><label style={{color:"white",fontFamily:'sans-serif'}}>Email</label><br></br>johndoe@gmail.com</div>
                    ...
                    <div class="form-group col-2" ><a href= "" style={{color:"red",fontFamily:'sans-serif',fontSize:"small"}}>Change</a></div>
                  </div> 
                  <div class="row" style={{fontSize: "initial"}}>
                  ...
                  <div class="row" style={{fontSize: "initial"}}>
                    ...
                    <div class="form-group col-4" ></div>
                    <div class="form-group col-2" ><a style={{color:"red",fontFamily:'sans-serif',fontSize:"small"}}>Change</a></div>
                  </div> 
                  <div class="row" style={{fontSize: "initial"}}>
                  ...
                  <div class="form-group col-6" style={{color:"white"}}><label style={{color:"white",fontFamily:'sans-serif'}}>Your next billing date is 19 september 2022</label></div>
                    ...
                    <div class="form-group col-3" ><a href= "" style={{color:"red",fontFamily:'sans-serif',fontSize:"small"}}>Update Payment info</a></div>
                  </div> 
                  <div class="row" style={{fontSize: "initial"}}>
                  ...
                  <div class="row" style={{fontSize: "initial"}}>
                    ...
                    <div class="form-group col-4" ></div>
                    <div class="form-group col-2" ><a href= "" style={{color:"red",fontFamily:'sans-serif',fontSize:"small"}}>change plan</a></div>
                  </div>
                </div>
                </div>
            </div>
